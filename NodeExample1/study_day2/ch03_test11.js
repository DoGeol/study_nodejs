...
console.log('push() before element length : %d', Users.length);

Users.push ( {name:'gyj', age:30} );
console.log('push() after element length : %d', Users.length);

Users.pop();
console.log('pop() after element length : %d', Users.length);
